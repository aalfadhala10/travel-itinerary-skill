...
**القاعدة:** أي رقم عربي-هندي من صفحة ممسوحة **يُحجَر ولا يدخل أي مقارنة إطلاقًا**.
يُعرض على المستخدم مع صورة الصفحة ليقرأه بنفسه. التخمين هنا يعني تعارضًا مفبركًا
على قيمة لم يكتبها أحد.

مطبَّق في `tools/construction-review/cr/ocr.py`، ومُختبَر في TP-002.
