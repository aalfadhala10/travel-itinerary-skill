...
const fs = require('fs');
const topo = JSON.parse(fs.readFileSync('package/countries-110m.json', 'utf8'));
...
console.log('countries:', out.c.length, 'bytes:', fs.statSync('world.json').size);
