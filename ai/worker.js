...
function appUrl(env) { return ev(env.APP_URL) || "https://bosla-b5w.pages.dev/"; }
...
const PHOTO_UA = { headers: { "User-Agent": "Bosla-Travel-App/1.0 (https://bosla-b5w.pages.dev/)" } };
